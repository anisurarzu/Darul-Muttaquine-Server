...
async function run() {
  try {
    ...
    */
    ...
    app.post("/investment-register", async (req, res) => {
      try {
        ...
        // investmentID বা userDMFID আগেই আছে কিনা চেক করা (optional)
        ...
        const result = await database.collection("investmentUsers").insertOne({
          ...
          investmentID,
          pinCode,
          numberOfShares: 0, // default 0 রাখতে পারো
          depositInfo: [], // টাকা জমার তথ্যগুলো রাখার জন্য empty array
          createdAt: now,
          updatedAt: now,
        });
    ...
    app.get("/investment-last-id", async (req, res) => {
      try {
    ...
    // Get investment details by investmentID (with user info)
    app.get("/investment/:investmentID", async (req, res) => {
      try {
    ...
    app.get("/investment-users", async (req, res) => {
      try {
    ...
    // Delete investment by investmentID
    app.delete("/investment/:investmentID", async (req, res) => {
      try {
        const { investmentID } = req.params;
    ...
    // Update investment (pinCode, numberOfShares)
    ...
    // Money Deposit (Add to depositInfo array)
    app.post("/investment/:id/deposit", async (req, res) => {
      try {
        const { id } = req.params;
